...
**참고 : Promotion fail GC 로그의 예**

```
2185 GC locker: Trying a full collection because scavenge failed
2186 251.229: [Full GC 251.229: [CMS251.495: [CMS-concurrent-...
2187   (concurrent mode failure): 3976820K->354739K(4135360K), ...
```
...
<img src="./gc-heap-usage.png" style="height:400px" />
...
<img src="./mat-leaks.png" style="height:410px" />
...
<img src="./threadlogic-bottleneck.png" style="height:380px" />
...
- IBM Heap analyzer
  - <ftp://public.dhe.ibm.com/software/websphere/appserv/support/tools/HeapAnalyzer/>
...
```
java -jar one-ftpserver.jar port=10021 id=benelog password=...
```
...
```java
@OnMethod(clazz = "/com\\.naver\\.good\\.service\\.work\\..*DAO/",
        method = "/.*/",
...
public static void dao(@Duration long duration, @ProbeClassName String className,
    ...
    Aggregations.addToAggregation(daoDuration, aggregationKey, duration);
    Aggregations.addToAggregation(daoCount, aggregationKey, 1);
}
```
...
<img src="./pinpoint-request-info.png" style="height:190px" />
...
<img src="./pinpoint-servermap.png" style="height:460px" />
