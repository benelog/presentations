...
* [발표 내용의 한 페이지 뷰](https://github.com/benelog/entity-dev/blob/master/src/index.adoc)
...
* Model 1?
* SMART UI 패턴
    * [Domain-Driven Design(에릭에반스, 2003)](https://www.amazon.com/Domain-Driven-Design-Tackling-Complexity-Software/dp/0321125215)의 1장에서 소개
...
### [QueryDSL 메뉴얼](http://www.querydsl.com/static/querydsl/3.4.2/reference/html/ch03s02.html)에 있는 DTO 관련 예제
...
* 값이 같으면 동일하다고 간주되는, 식별성이 없는 작은 객체 (예 : Money, Color )
    * [마틴파울러의 정의](https://martinfowler.com/bliki/ValueObject.html), [위키페디아의 정의](https://en.wikipedia.org/wiki/Value_object)
    * [JEP 169 : Value Object](https://openjdk.java.net/jeps/169)
    * DDD에서도 이 정의를 따르고 있음.
    * [Hibernate 메뉴얼의 Value Type](https://docs.jboss.org/hibernate/stable/core.old/reference/en/html/mapping-types.html)도 Value Object를 포함한다고 생각됨.
...
* 사전적 의미 : 실체. [Something that exists apart from other things, having its own independent existence](https://dictionary.cambridge.org/ko/%EC%82%AC%EC%A0%84/%EC%98%81%EC%96%B4/entity)
...
— [Stackoverflow](https://stackoverflow.com/a/4922100)의 한 답변
...
— [CQRS Journey의 Chapter 3](https://github.com/microsoftarchive/cqrs-journey/blob/master/docs/Journey_03_OrdersBC.markdown)
...
### MyBatis — 쿼리 결과 매핑의 한계

* 쿼리 결과 -> Entity 매핑 때 Entity 속성명을 Type safe하게 지정할 수 있는 방법이 없음
    * description이라는 속성명을 오타를 쳐도 컴파일 시점에는 모름.
        * SELECT desc as description 으로 써서 자동 매핑해도 마찬가지
...
* [Domain-Driven Design with Relational Databases Using Spring Data JDBC](https://www.slideshare.net/SpringCentral/domaindriven-design-with-relational-databases-using-spring-data-jdbc) (SpringOne Platform 2019의 발표)
* [Open Session in View Pattern](http://aeternum.egloos.com/2798098)  (조영호 님의 블로그)
* [DAO와 REPOSITORY 논쟁](http://aeternum.egloos.com/1160846)  (조영호 님의 블로그)

---

### 참고 & 추천 자료 — 우아한 객체지향

[우아한 객체지향](https://www.slideshare.net/baejjae93/ss-151545329) (우아한 테크 세미나 2019.06.20)

* [발표 영상](https://youtu.be/GOSW911Ox6s)
* 99쪽 : 어떤 객체를 묶고 어떤 객체들을 분리할 것인가?
* 103쪽 : 경계 밖의 객체는 ID를 이용해 접근
* 169쪽 : 도메인 단위 모듈 = 시스템 분리의 기반
* [전체 내용을 글로 풀어서 정리한 블로그 포스트](https://velog.io/@codemcd/%EC%9A%B0%EC%95%84%ED%95%9C%ED%85%8C%ED%81%AC%EC%84%B8%EB%AF%B8%EB%82%98-%EC%9A%B0%EC%95%84%ED%95%9C%EA%B0%9D%EC%B2%B4%EC%A7%80%ED%96%A5-%EC%9D%98%EC%A1%B4%EC%84%B1%EC%9D%84-%EC%9D%B4%EC%9A%A9%ED%95%B4-%EC%84%A4%EA%B3%84-%EC%A7%84%ED%99%94%EC%8B%9C%ED%82%A4%EA%B8%B0-By-%EC%9A%B0%EC%95%84%ED%95%9C%ED%98%95%EC%A0%9C%EB%93%A4-%EA%B0%9C%EB%B0%9C%EC%8B%A4%EC%9E%A5-%EC%A1%B0%EC%98%81%ED%98%B8%EB%8B%98-vkk5brh7by)

---

### 참고 & 추천 자료 — Effective Aggregate Design
