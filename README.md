...
**배포 URL**: <https://presentations.benelog.net/>
...
| 2017-11-26 | HTTP/2 세대의 Java | [KSUG(한국 스프링 사용자 모임) 세미나](https://www.ksug.org/seminar/20171126/) | [`20171126-http2-java/slides.md`](20171126-http2-java/slides.md) | [보기](https://presentations.benelog.net/20171126-http2-java/) | [PDF](https://presentations.benelog.net/20171126-http2-java/slides.pdf) |
| 2017-04-23 | Spring/KSUG에 대한 기억 몇가지 | [Spring Camp 2017](https://springcamp.ksug.org/2017/) | [`20170423-spring-camp-2017/slides.md`](20170423-spring-camp-2017/slides.md) | [보기](https://presentations.benelog.net/20170423-spring-camp-2017/) | [PDF](https://presentations.benelog.net/20170423-spring-camp-2017/slides.pdf) |
| 2015-10-22 | 네이버의 오픈소스 프로젝트가 성장한 과정 | 삼성SDS Open IT 세미나 | [`20151022-naver-opensource-growth/slides.md`](20151022-naver-opensource-growth/slides.md) | [보기](https://presentations.benelog.net/20151022-naver-opensource-growth/) | [PDF](https://presentations.benelog.net/20151022-naver-opensource-growth/slides.pdf) |
...
| 2011-09-06 | 오픈 API 기술의 이해 | 삼성 SDS 멀티캠퍼스 강의 | [`20110906-open-api-tech/slides.md`](20110906-open-api-tech/slides.md) | [보기](https://presentations.benelog.net/20110906-open-api-tech/) | [PDF](https://presentations.benelog.net/20110906-open-api-tech/slides.pdf) |
| 2010-11-13 | SpringOne2GX 2010 참석 후기 | KSUG(한국 스프링 사용자 모임) 세미나 | [`20101113-springone2gx/slides.md`](20101113-springone2gx/slides.md) | [보기](https://presentations.benelog.net/20101113-springone2gx/) | [PDF](https://presentations.benelog.net/20101113-springone2gx/slides.pdf) |
...
- 디렉터리 통째로인 원본(reveal.js, remark 로 만든 HTML 자료)은 `originals/YYYYMMDD-slug/`
  ...
  `20110906-open-api-tech/` 는 강의 때 쓰던 네이버 카페 [openapibiz](https://cafe.naver.com/openapibiz) 의
...
빌드는 증분 방식: 소스가 바뀐 발표만 다시 빌드한다 (`scripts/build.sh` 가 `dist/<발표>/.build-hash` 로 판단).

자세한 작성 규칙·파이프라인은 [`build_slides.md`](build_slides.md) 참고.

## 화면 잘림 검사

콘텐츠가 슬라이드 캔버스(1280×720)를 넘어 하단이 잘리는 슬라이드를 자동 검출한다.
슬라이드를 한 장씩 실제로 렌더링해서 측정하므로 느리다(29장짜리 덱 1개에 약 11초, 전체 덱은 수 분).
그래서 빌드 과정에는 포함하지 않았고, 필요할 때만 수동으로 실행한다.

```bash
npm run build                                    # 먼저 dist/ 생성
npm run check                                    # 전체 덱 검사 (잘림 있으면 exit code 1)
npm run check -- 20140608-spring-anti-patterns   # 특정 덱만 검사
```

잘리는 슬라이드는 텍스트/리스트면 페이지 분할, 이미지가 원인이면 이미지 height 축소로 수정한다.
